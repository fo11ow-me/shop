...
echo "========== 4. 构建前端 =========="
cd "$SCRIPT_DIR"/../mall-admin && npm run build 2>&1 | tail -1 && cd "$SCRIPT_DIR"
cd "$SCRIPT_DIR"/../mall-portal && npm run build 2>&1 | tail -1 && cd "$SCRIPT_DIR"
